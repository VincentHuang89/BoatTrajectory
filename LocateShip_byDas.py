...
if __name__ =='__main__':
    ...
    print(SHIP)
    lat0,lng0,dasCh = SHIP.iloc[0]['lat'], SHIP.iloc[0]['lng'],SHIP.iloc[0]['CrossDistDas']
    ...
    getDistance(FIBER_1[0], FIBER_1[1],FIBER_5[0], FIBER_5[1])*1000
    
    print(getDistance(22.161556,113.713453,22.167042, 113.795592)*1000)